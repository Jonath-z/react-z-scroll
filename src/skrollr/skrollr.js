 ...
 */
function _skrollr(window, document) {
  'use strict'
    ...
    var _render = function () {
      ...
      if (_scrollAnimation) {
        ...
        if (now >= _scrollAnimation.endTime) {
          ...
          renderTop =
            (_scrollAnimation.startTop + progress * _scrollAnimation.topDiff) |
            0
        }
      ...
      //Smooth scrolling only if there's no animation running and if we're not forcing the rendering.
        ...
        if (now <= _smoothScrolling.endTime) {
          ...
          renderTop =
            (_smoothScrolling.startTop + progress * _smoothScrolling.topDiff) |
            0
        }
      }
